...
return (
    <div className='container'>  
        ...
        <h1 className='titles'> My Monsters</h1>
        ...
        <div className='leaderboard'>
            <table className="table">
                <thead style={{background:'rgb(179, 147, 108)'}}>
                    ...
                    <th  className="fighter4" style={{color: "white"}}>Reroll</th>
                    <th className="fighter4" style={{color: "white"}}>Train</th>
                    ...
                    .map((mon, index) => {
                        return (
                            <tr key={index}>
                                ...
                                <td className="fighter4" style={{color: "white"}}> <Link to={`/updatemonster/${mon._id}`}  style={{color: "white", textDecoration: "none"}}>Reroll {mon.name}'s stats</Link> </td>
                                <td className="fighter4" style={{color: "white"}}> <Link to={`/trainmonster/${mon._id}`}  style={{color: "white", textDecoration: "none"}}> Train {mon.name}</Link> </td>
